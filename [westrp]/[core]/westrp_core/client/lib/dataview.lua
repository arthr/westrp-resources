--[[
    WestRP Framework — Binary DataView Library
    Target: RedM (CitizenFX RDR3 - Lua 5.4)
    Zero Dependências com VORP ou bibliotecas externas.
    Baseado na especificação original DataView para CitizenFX.
]]
